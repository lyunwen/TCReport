...
{
	/// <summary>
	/// 类tc_report_default_preworkcontent。
	/// </summary>
	[Serializable]
	public partial class tc_report_default_preworkcontent
	{
		public tc_report_default_preworkcontent()
		{}
		#region Model
		private long _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [tc_report_default_preworkcontent]");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [tc_report_default_preworkcontent] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [tc_report_default_preworkcontent] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [tc_report_default_preworkcontent] ");
			strSql.Append(" where ID=@ID ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.bigint)};
			parameters[0].Value = ID;
